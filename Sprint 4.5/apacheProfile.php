...
<html lang="en">
    <head>
        <title>Augur: Apache Profile</title>
        <meta charset="utf-8">
       ...
       <!-- Latest compiled and minified CSS -->
        ...
        <script src="apacheGroup.js"></script>
    </head>

    <body id="apacheProfileBody" onload="getRepoGroupInfo()">   
        ...
        <h1 id="pageTitle">Welcome Apache Repo Group!</h1>
            ...
            <div id = "innerWrapper">
                ...
                <div id="secondaryWrapper">
                   <div id="otherFunctionProfileWrapper">
                     <h3 id="viewZephyrRepoLine">View Repos In Apache!</h3>   
                       <p class="repoDropdown"><select id="apacheDrop" name="Apache-Repos"><option>View Repos ↓</option></select></p>
                   </div>
                   <div id="profileLogoWrapper"><img src="apacheLogo.png" alt="Apache Logo" class="albumCover"></div>
                </div>
            </div>
        </div>    
    </body>
