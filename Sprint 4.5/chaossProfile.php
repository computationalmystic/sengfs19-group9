...
<html lang="en">
    <head>
        <title>Augur: CHAOSS Profile</title>
        <meta charset="utf-8">
       ...
       <!-- Latest compiled and minified CSS -->
        ...
        <script src="chaossGroup.js"></script>
    </head>

    <body id="chaossProfileBody" onload="getRepoGroupInfo()">   
        ...
        <h1 id="pageTitle">Welcome CHAOSS Repo Group!</h1>
            ...
            <div id = "innerWrapper">
                ...
                <div id="secondaryWrapper">
                   <div id="otherFunctionProfileWrapper">
                     <h3 id="viewZephyrRepoLine">View Repos In CHAOSS!</h3>   
                       <p class="repoDropdown"><select id="chaossDrop" name="CHAOS-Repos"><option>View Repos ↓</option></select></p>
                   </div>
                   <div id="profileLogoWrapper"><img src="chaossLogo.png" alt="CHAOSS Logo" class="albumCover"></div>
                </div>
            </div>
        </div>    
    </body>
