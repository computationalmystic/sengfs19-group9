...
<html lang="en">
    <head>
       ...
       <!-- Latest compiled and minified CSS -->
        ...
        <script src="mhsGroup.js"></script>
    </head>

    <body id="mhsProfileBody" onload="getRepoGroupInfo()">   
        ...
        <h1 id="pageTitle">Welcome MHS Repo Group!</h1>
            ...
            <div id = "innerWrapper">
                ...
                <div id="secondaryWrapper">
                   <div id="otherFunctionProfileWrapper">
                     <h3 id="viewZephyrRepoLine">View Repos In MHS!</h3>   
                       <p class="repoDropdown"><select id="mhsDrop" name="MHS-Repos"><option>View Repos ↓</option></select></p>
                   </div>
                   <div id="profileLogoWrapper"><img src="mhsLogo.png" alt="MHS Logo" class="albumCover"></div>
                </div>
            </div>
        </div>    
    </body>
