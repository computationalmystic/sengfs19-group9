...
<html lang="en">
    <head>
        <title>Augur: Netflix Profile</title>
        <meta charset="utf-8">
       ...
       <!-- Latest compiled and minified CSS -->
        ...
        <script src="netflixGroup.js"></script>
    </head>

    <body id="netflixProfileBody" onload="getRepoGroupInfo()">   
        ...
        <div class="navbar">
            ...
            echo '<div class="dropdown">';
                ...
                echo '<a class="active" href="netflixProfile.php">Profile</a>';
                echo '<a>Settings</a>';
            echo '<div class="dropdown">';
                echo '<button class="dropbtn"><img src="logInNavbar.jpg"></button>';
                echo '<div class="dropdown-content"><a href="logOut.php">Logout</a></div>';
        ...
        <h1 id="pageTitle">Welcome Netflix Repo Group!</h1>
            ...
            <div id = "innerWrapper">
                ...
                <div id="secondaryWrapper">
                   <div id="otherFunctionProfileWrapper">
                     <h3 id="viewZephyrRepoLine">View Repos In Netflix!</h3>   
                       <p class="repoDropdown"><select id="netflixDrop" name="Netflix-Repos"><option>View Repos ↓</option></select></p>
                   </div>
                   <div id="profileLogoWrapper"><img src="netflixLogo.png" alt="Netflix Logo" class="albumCover"></div>
                </div>
            </div>
        </div>    
    </body>
